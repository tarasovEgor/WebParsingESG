...
#     for tag in soup.find_all(['a', 'iframe', 'embed'], href=True) + soup.find_all(['iframe', 'embed'], src=True):
...
#             print(f"Downloading relevant PDF: {pdf_url}")
...
#     company, url, inn, output_dir = args
#     driver = init_driver()
#     company_data = []
#     parsed_links = set()
...
#     except Exception as e:
#         print(f"[{company}] Error in scrape_company_task: {e}")
#     finally:
#         driver.quit()
